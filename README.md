...
<code>apt update && apt upgrade -y && apt install sudo git -y && sudo rm -rf yugoticket && sudo git clone https://github.com/yurigoes/Whaticket-Saas-Completo.git && cd yugoticket && sudo chmod +x ./devconnectai && ./devconnectai</code><br />
